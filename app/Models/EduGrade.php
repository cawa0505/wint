...
class EduGrade extends EduModel
{
	...
	->leftJoin('edu_teachers','edu_teachers.id','=','edu_grades.teacher_id') 
           ->select('edu_grades.*', 'edu_courses.name as course_name','edu_teachers.name as teacher_name', 'edu_courses.is_common as course_common', 'edu_courses.is_required as course_required', 'edu_courses.code as course_code')
->get();
